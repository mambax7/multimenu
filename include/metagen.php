...
function multimenu_meta_description( $meta_description='', $description='' ) {
...
// Meta Description
     $meta_description = multimenu_meta_description($xoopsModuleConfig['meta_description'], (isset($description)?$description:''));
if ( $meta_description ) {
