...
DHTMLSuite.config.prototype = {
	...
	init : function()
	{
		this.imagePath = '{xoops_root}/modules/multimenu/templates/include/multimenu_suite_vertical/';	// Path to images
		this.cssPath = '{xoops_root}/modules/multimenu/templates/include/multimenu_suite_vertical/';	// Path to images
	}	
	// }}}
	,
	// {{{ setCssPath()
...
DHTMLSuite.menuItem = function()
{
	...
	this.layoutCSS = '../../uploads/multimenu/cache/multimenu_suite_vertical_{id}.css';
