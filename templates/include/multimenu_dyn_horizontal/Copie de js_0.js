...
// Edit settins here
var menuwidth_{id}='160'; 		//default menu width
var menubgcolor_{id}='white';	//menu bgcolor
...
edgeoffset_{id}=dropmenuobj_{id}.contentmeasure-23 //gère la hauteur d'affichage du menu déroulant
