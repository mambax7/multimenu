   ...
   $ret .= '
                <div align="right" style="font-weight:bold; text-align:rigth;">
                 ...
                 <a title="show/hide"
                    ...
                    onclick="toggle(this, \'select_thumb_gen_infos\');">[-]</a>['._MD_MULTIMENU_SERVER_CONF.']
                 </div>
...
$ret .= '<h2>'._MD_MULTIMENU_SERVER_CONF.'</h2>';
...
$ret .= _MD_MULTIMENU_XOOPS_VERSION." : <b>".XOOPS_VERSION." (".$test.")</b><br /><br />";

// if($xoopsModuleConfig['graphic_lib'] == 'GD') {
	// GD graphic lib
	$test = ($gd['GD Version'] == "") ? "<span style=\"color:#FF0000;\"><b>KO</b></span>" : $gd['GD Version'];
	$ret .= _MD_MULTIMENU_GRAPH_GD_LIB_VERSION." : <b>".$test."</b><br />";
...
if( !is_dir(XOOPS_ROOT_PATH.'/'.$dir) ) {
	$isError = true;
	$errors[] = "<b>"._MD_MULTIMENU_DIR."</b> (".XOOPS_ROOT_PATH.'/'.$dir.") : <span style=\"color:#FF0000;\"><b>"._MD_MULTIMENU_NOT_CREATED."</b></span>";
} else if(!thumb_gen_is_writable(XOOPS_ROOT_PATH.'/'.$dir)) {
	$isError = true;
	$errors[] = "<b>"._MD_MULTIMENU_DIR."</b> (".XOOPS_ROOT_PATH.'/'.$dir.") : <span style=\"color:#FF0000;\"><b>"._MD_MULTIMENU_NOT_WRITABLE."</b></span>";
} else { $ret .= _MD_MULTIMENU_DIR." : ".$dir." <span style=\"color:#33CC33;\"><b>OK</b></span><br />"; }
