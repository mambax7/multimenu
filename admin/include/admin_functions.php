...
function sup_admin_menu() {
  ...
  $HELP     = admin_define( 'help' );
   ...
   foreach( $headermenu as $header_menu ) {
	...
	$ret .= '&nbsp;' . admin_url_selector( 0, $nav,'../item.php?id=','|', 'select', 'multimenu_menu|catid|title|status');
 }
Return $ret;
}
...
function admin_menu($currentoption=0, $breadcrumb) {
	global $xoopsConfig, $xoopsModule, $module, $xoopsModuleConfig, $myts;
...
$breadcrumb = admin_define( $breadcrumb ); // @constant(strtoupper('_MD_' . $xoopsModule->dirname() . '_' . $breadcrumb));
 ...
 // Header main module menu
	...
	$ret .= '<td style="font-size: 18px; text-align: left; color: Black;
                         ...
                         font-weight: bold;"><a href="../" title="' . $xoopsModule->dirname() . '"  />' . $myts->makeTareaData4Show($xoopsModule->name()) . '</a></td>';
        ...
        if( $admin_menu_list ) {
        	...
        	$ret .= '<li id="' . $current . '">
                             <a href="index.php?admin=' . $adminmenu['link'] . '"
                                ...
                                '.$help.'>
                             <span>
                             ' . $myts->makeTareaData4Show($adminmenu['title']) . '
                             </span>
                             </a>
                      </li>';
                }
...
function admin_footer() {
  Global $xoopsModule;
    ...
    $ret .= '<img src="../images/logo-48.png"
                  ...
                  border="0"
                  align="absmiddle" />';
    $ret .= sprintf(admin_define( 'credit' ),'Multimenu', '<a href="http://www.comptoir-des-medias.com" target="_blank">Comptoir des Medias</a>' );
...
function admin_icon_legend( $width=48 ) {
 ...
 <ul style="font-style:italic;">
     <li style="display:inline;"><img src="../images/icon/on.gif" alt="on" align="absmiddle" /> '._MD_MULTIMENU_ONLINE.' |</li>
     <li style="display:inline;"><img src="../images/icon/hidden.gif" alt="hidden" align="absmiddle" /> '._MD_MULTIMENU_HIDDEN.' |</li>
     <li style="display:inline;"><img src="../images/icon/off.gif" alt="off" align="absmiddle" width="18" /> '._MD_MULTIMENU_OFFLINE.'</li>
     <br />
     <li style="display:inline;"><img src="../images/icon/menu.png" alt="menus" align="absmiddle" width="'.$width.'" /> '._MD_MULTIMENU_MENU.' |</li>
     <li style="display:inline;"><img src="../images/icon/link.png" alt="links" align="absmiddle" /> '._MD_MULTIMENU_LINK.' |</li>
     <li style="display:inline;"><img src="../images/icon/images.png" alt="images" align="absmiddle" /> '._MD_MULTIMENU_IMAGE.' |</li>
     <li style="display:inline;"><img src="../images/icon/templates.png" alt="template" align="absmiddle" width="'.$width.'" /> '._MD_MULTIMENU_TEMPLATE.' </li>
     <br />
     <li style="display:inline;"><img src="../images/icon/permanent.png" alt="permanent" align="absmiddle" width="'.$width.'" /> '._MD_MULTIMENU_PERMANENT.' |</li>
     <li style="display:inline;"><img src="../images/icon/relative.png" alt="relative" align="absmiddle" width="'.$width.'" /> '._MD_MULTIMENU_RELATIVE.' |</li>
     <li style="display:inline;"><img src="../images/icon/link_in.png" alt="in" align="absmiddle" width="'.$width.'" /> '._MD_MULTIMENU_LINKIN.' |</li>
     <li style="display:inline;"><img src="../images/icon/link_out.png" alt="out" align="absmiddle" width="'.$width.'" /> '._MD_MULTIMENU_LINKOUT.' |</li>
     <li style="display:inline;"><img src="../images/icon/query.png" alt="query" align="absmiddle" width="'.$width.'" /> '._MD_MULTIMENU_QUERY.'</li>
     <br />
     <li style="display:inline;"><img src="../images/icon/_self.png" alt="self" align="absmiddle" width="'.$width.'" /> '._MD_MULTIMENU_SELF.' |</li>
     <li style="display:inline;"><img src="../images/icon/_blank.png" alt="blank" align="absmiddle" width="'.$width.'" /> '._MD_MULTIMENU_BLANK.'</li>
     <br />
     <li style="display:inline;"><img src="../images/icon/bulle.png" alt="infobulle" align="absmiddle" width="'.$width.'" /> '._MD_MULTIMENU_INFOBULLE.' |</li>
     <li style="display:inline;"><img src="../images/icon/css.png" alt="css" align="absmiddle" /> '._MD_MULTIMENU_CSS.' |</li>
     <li style="display:inline;"><img src="../images/icon/none.png" alt="trouble" align="absmiddle" /> '._MD_MULTIMENU_TROUBLE.'</li>
     <br />
     <li style="display:inline;"><img src="../images/icon/edit.png" alt="edit" align="absmiddle" /> '._MD_MULTIMENU_EDIT.' |</li>
     <li style="display:inline;"><img src="../images/icon/clone.png" alt="clone" align="absmiddle" /> '._MD_MULTIMENU_CLONE.' |</li>
     <li style="display:inline;"><img src="../images/icon/delete.png" alt="delete" align="absmiddle" /> '._MD_MULTIMENU_DELETE.'</li>
...
function  admin_display_tip( $tip=0 ) {
  	...
  	if (file_exists('../language/' . $xoopsConfig['language'] . '/tips.php')) {
        ...
        $tip_text = constant( '_TI_MULTIMENU_'.$rand );
        $tip = explode( '|', $tip_text );
        $tip_icon = eregi('Astuce', $tip[0])?'tip':'info';
        $ret  = '<div align="center">';
        $ret .= Admin_OpenTable( '480px', 'overflow:Auto; background-color:LightYellow; height:110px; border: Black 2px Inset; margin:6px;' );
        $ret .= isset($tip[2])?'<h3><a href="'.$tip[2].'">':'<h3>';
        $ret .= '<img src="../images/icon/'.$tip_icon.'.gif" align="left" />';
        $ret .= isset($tip[2])?$tip[0].'</a></h3>':$tip[0].'</h3>';
        $ret .= $tip[1];
        $ret .= '<div style="text-align:right;font-size:70%;"><br />'.$rand. '/'.$tips_count. '
                 <a href="index.php?admin=help&sub=tips">[?]</a>
                 <a href="index.php?admin=settings&num=20">[X]</a>
                 </div>';
        $ret .= Admin_CloseTable();
        $ret  .= '</div>';
