...
#                                                                                                               #
#    Exemple :                                                                                                  #
#            _MI_MULTIMENU_BANNER                                                                                   #
#            _MI_MULTIMENU_TEXTE_INDEX                                                                              #
#            _MI_MULTIMENU_VALUE1                                                                                   #
#            _MI_MULTIMENU_VALUE2                                                                                   #
#                                                                                                               #
...
<ul>
  ...
  <li>Edit your language/english/modinfo.php file and enter the new language define as following
    ...
    ** If you don't create your custom define, a default title will appear with a red <font color='red'>*</font>.
    ...
    Exemple :<ol>
            <li>_MI_MULTIMENU_BANNER</li>     <li>_MI_MULTIMENU_TEXTE_INDEX</li>        <li>_MI_MULTIMENU_VALUE1</li>      <li>_MI_MULTIMENU_VALUE2</li></ol>
  </li>
