...
*/
        ...
        // CSS
        $css_file_name = 'multimenu_'.$tpl.'_0.css';
        ...
        // Script
        $script_file_name = 'multimenu_'.$tpl.'_0.js';
        ...
        $script = file_exists( $script_file )?multimenu_read_file( $script_file ):'';
        ...
        $sql = " SELECT a.tpl_id, b.tpl_source
                 ...
                 WHERE a.tpl_tplset='".$xoopsConfig['template_set']."'
                   ...
                   AND a.tpl_file= 'include/".$file_name.".html'";
        ...
        $myrow['tpl_source'] = file_exists( $tpl_file )?multimenu_read_file( $tpl_file ):'';
        $myrow['tpl_id']='';
        }
        $tpl_is_open = $xoopsConfig['template_set']=='default'||!$myrow['tpl_id']?0:1;

        $formcss    = new XoopsFormTextArea(_MD_MULTIMENU_CSS . ' :<br />' .$css_file_name, "css", $css, 25);
        $formscript = new XoopsFormTextArea(_MD_MULTIMENU_SCRIPT . ' :<br />' .$script_file_name, "script", $script, 25);
        $formtpl    = new XoopsFormTextArea(_MD_MULTIMENU_TPL . ' : ' . $file_name.'.html', "tpl_source", $myrow['tpl_source'], 25);
...
include('java.help.php');
    $css_drop      = multimenu_drop_form( _MD_MULTIMENU_CSS, _HLP_MULTIMENU_CSS, _MD_MULTIMENU_HELP, $css_is_open );
    $script_drop   = multimenu_drop_form( _MD_MULTIMENU_SCRIPT, _HLP_MULTIMENU_SCRIPT, _MD_MULTIMENU_HELP, $script_is_open);
    $template_drop = multimenu_drop_form( _MD_MULTIMENU_TPL, _HLP_MULTIMENU_TPL, _MD_MULTIMENU_HELP, $tpl_is_open );
